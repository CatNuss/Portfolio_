...
//ABOUT
    ...
    $(".adobe").hide();
        ...
        $(".adobebutt").click(function(){
            $(".webdev").fadeOut("slow", "linear").hide;
            $(".adobe").delay(800).fadeIn("slow", "linear").show;
        });
    

        $(".webdevbutt").click(function(){
            $(".adobe").fadeOut("slow", "linear").hide;
            $(".webdev").delay(800).fadeIn("slow", "linear").show;
        });
